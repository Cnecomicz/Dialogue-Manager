...
class ElementId(StrEnum):
    ...
    CONFIRM_UNSAVED_CANCEL = "confirm-unsaved-cancel"
    CONFIRM_UNSAVED_CONFIRM = "confirm-unsaved-confirm"
    CONFIRM_UNSAVED_MESSAGE = "confirm-unsaved-message"
    CONFIRM_UNSAVED_VISIBLE = "confirm-unsaved-visible"
